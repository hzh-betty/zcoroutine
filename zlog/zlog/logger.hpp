...
namespace zlog
{
    ...
    protected:
        ...
        void logImplHelper(const LogLevel::value level, const char *file, const size_t line, const char *fmt, Args &&...args)
        {
    ...
    public:
        ...
        AsyncLogger(const char *loggerName, const LogLevel::value limitLevel,
                    ...
                    std::chrono::milliseconds milliseco) : Logger(loggerName, limitLevel, formatter, sinks),
                                                           looper_(std::make_shared<AsyncLooper>(AsyncLooper::Functor{
    ...
    public:
        ...
        {
            const LogSink::ptr psink = SinkFactory::create<SinkType>(std::forward<Args>(args)...);
