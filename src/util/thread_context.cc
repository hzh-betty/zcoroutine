...
Fiber *ThreadContext::get_main_fiber() { return get_current()->main_fiber_; }
...
Scheduler *ThreadContext::get_scheduler() { return get_current()->scheduler_; }

void ThreadContext::set_stack_mode(StackMode mode) {
  get_current()->stack_mode_ = mode;
}

StackMode ThreadContext::get_stack_mode() { return get_current()->stack_mode_; }
...
bool ThreadContext::is_hook_enabled() { return get_current()->hook_enable_; }
...
int ThreadContext::call_stack_size() { return get_current()->call_stack_size_; }
